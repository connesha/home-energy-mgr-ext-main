...
class BaseDevice(ABC):
    ...
    async def fetch_history_data(
        ...
        return_data = {
            ...
            "h1d": round(energy_wh["h1d"] / 1000, 2),
            "h2d": round(energy_wh["h2d"] / 1000, 2),
            "h1b": round(energy_wh["h1b"] / 1000, 2),
            "h2b": round(energy_wh["h2b"] / 1000, 2),
            "h3d": round(energy_wh["h3d"] / 1000, 2),
            "h3b": round(energy_wh["h3b"] / 1000, 2),
            "device_total": round(
